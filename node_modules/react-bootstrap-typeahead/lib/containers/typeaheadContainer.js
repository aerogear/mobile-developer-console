  ...
  function (_React$Component) {
    ...
    function WrappedTypeahead() {
      ...
      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleRootClose", function (e) {
        ...
        // `document.body`.
        var isBodyMenuClick = (_this.props.bodyContainer || _this.props.positionFixed) && e.path.some(function (_ref3) {
          var className = _ref3.className;
          return className && className.indexOf('rbt-menu') > -1;
        });

        if (isBodyMenuClick || !_this.state.showMenu) {
          return;
        }
